			...
			<div className="flex justify-center px-6 pt-28 pb-16">
				...
				>
					...
					<section>
						...
						<div className="flex justify-between gap-4">
							<div>
								...
								<p className="text-[#0f0e0e]/60 text-sm">GPA: 3.99</p>
							</div>
					...
					<section>
						...
						<ul className="flex flex-col gap-1">
							{[
								"Led and collaborated with diverse teams while teaching and mentoring full-time for two years",
								"Developed strong communication and leadership skills in English and Spanish",
							].map((b, i) => (
								<li key={i} className="text-[#0f0e0e]/70 text-sm leading-relaxed flex gap-2">
									<span className="text-[#ff7c5c] shrink-0">–</span>
									{b}
